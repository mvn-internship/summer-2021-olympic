...
class MatchResultController extends Controller
{
    ...
    {   
        ...
        $id = $tournaments->last()->id;
        $pointRules = Tournament::with('individual.rank.pointRule')->find($id);
        if( $pointRules->individual == null){
            return view('user.pages.matches.ranking', ['tournaments'=> $tournaments, 'notification' => __('message.updating')]);
        }
        ...
        return view('user.pages.matches.ranking', ['points' => $pointArr, 'tournaments' => $tournaments]);
    }
